...
export const uk: Record<keyof typeof en, Message> = {
  ...
  "accounts.removeConfirm": "Видалити цей акаунт? Минулі розмови залишаться доступними.",
  ...
  "draft.handoffLabel": "продовжує: {title}",
  "draft.newConvo": "нова розмова",
  "draft.advanced": "Налаштування",
  "draft.advancedAria": "Налаштування запуску агента",
  "draft.summaryModelDefault": "типова",
  "draft.summaryEffortDefault": "типові",
  "draft.hintNewShort": "Напиши перший промпт — агент почне працювати тут.",
  "draft.hintRelayShort": "Агент прочитає розмову і продовжить звідти.",
  "draft.summaryConversation": "розмова",
  "draft.clearDirAria": "Без теки — просто розмова",
  "draft.noDirHint": "Без теки: агент працює у домашній теці, це просто розмова.",
  "launch.directory": "Тека",
  ...
  /* Підключення другого Telegram-акаунта за номером телефону: QR, показаний
     на тому самому телефоні, відсканувати нічим. */
  "telegram.addAccount": "+ Telegram-акаунт",
  "telegram.slug": "Ідентифікатор",
  "telegram.phone": "Номер телефону",
  "telegram.sendCode": "Надіслати код",
  "telegram.code": "Код із Telegram",
  "telegram.codeInvalid": "Код не підійшов",
  "telegram.floodWait": "Telegram просить зачекати {seconds} с",
  "telegram.connected": "Підключено: {who}",
  "telegram.byPhone": "за номером",
  "telegram.accounts": "Акаунти",
  "telegram.vaultMissing": "Сейф не записав сесію: {reason}",
  "telegram.err.phone_invalid": "Такий номер Telegram не приймає.",
  "telegram.err.code_invalid": "Код не підійшов.",
  "telegram.err.flood_wait": "Telegram просить зачекати перед наступною спробою.",
  ...
  "status.stalled": "немає нових даних",
  ...
  "orchPanel.errorCwd": "Цього проєкту немає на машині, де працює дашборд — сюди приїхали лише його розмови. Оркестратора можна посадити тільки там, де лежить сама тека: обери проєкт, який є на цій машині, або відкрий дашборд тієї машини.",
  ...
  "readiness.title": "Готовність задач",
  "readiness.aria": "Секції готовності всіх задач проєкту",
  "readiness.legend": "Зараз — призначено в роботу · На рев'ю — рев'ю триває або є вердикт · Заблоковано — потрібне рішення · Заплановано — інбокс/беклог · Готово — завершено",
  "readiness.section.now": "Зараз",
  "readiness.section.review": "На рев'ю",
  "readiness.section.blocked": "Заблоковано",
  "readiness.section.planned": "Заплановано",
  "readiness.section.done": "Готово",
  "readiness.sectionAria": "Задачі «{section}» · {count}",
  "readiness.open": "Відкрити задачу на дошці: {title}",
  "readiness.place": "Розмістити задачу на мапі: {title}",
  "readiness.issueAria": "Відкрити issue #{issue} на GitHub",
  "readiness.agent": "агент",
  "readiness.agentAria": "Відкрити призначеного агента: {title}",
  "readiness.pipeline": "пайплайн",
  "readiness.pipelineAria": "Відкрити стадію пайплайна: {title}",
  "readiness.review": "рев'ю",
  "readiness.reviewAria": "Відкрити пов'язане рев'ю: {title}",
  "readiness.state.live": "живий",
  "readiness.state.gone": "зник",
  "readiness.state.failed": "збій",
  ...
  "workerStack.idle": { one: "{count} у простої", few: "{count} у простої", many: "{count} у простої", other: "{count} у простої" },
  "workerStack.noVerdict": "без вердикту",
  ...
  "task.lostBadge": "звʼязок втрачено під час ходу",
  "task.sessionEndedBadge": "сесію завершено",
  "task.noNewDataBadge": "немає нових даних",
  ...
  "tasks.openS\x6furce": "відкрити й показати розмову-джерело",
  "tasks.openS\x6furceAria": "Відкрити розмову-джерело {title}",
  "tasks.openS\x6furceUnavailableAria": "Відкрити розмову-джерело {title} — недоступно: {reason}",
  ...
  "mobile2.tabs.aria": "Розділи застосунку",
  "mobile2.tabs.chat": "Чат",
  "mobile2.tabs.sessions": "Сесії",
  "mobile2.tabs.secrets": "Секрети",
  "mobile2.tabs.mcp": "MCP",
  "mobile2.tabs.settings": "Налаштування",
  "mobile2.settings.title": "Налаштування",
  "mobile2.soon.chat": "Груповий чат з оркестратором і агентами — ще не зроблено.",
  "mcp.up": "живий",
  "mcp.down": "мертвий",
  "mcp.grantedToNobody": "нікому не виданий",
  "mcp.editGrants": "Змінити, кому виданий {item}",
  "mcp.grantTitle": "Кому видати {item}",
  "mcp.grantTarget": "Ціль",
  "mcp.grantHint": "firm:<id> · project:<id> · agent:<роль> · fleet:hq · fleet:worker",
  "mcp.grant": "Видати",
  "mcp.revoke": "Забрати",
  "mcp.add": "+ Сервер",
  "mcp.addTitle": "Новий MCP-сервер",
  "mcp.name": "Імʼя",
  "mcp.type": "Тип",
  "mcp.command": "Команда",
  "mcp.args": "Аргументи, по одному в рядку",
  "mcp.cwd": "Робоча тека",
  "mcp.url": "URL",
  "mcp.env": "Змінні середовища",
  "mcp.headers": "Заголовки",
  "mcp.addRow": "+ рядок",
  "mcp.replace": "Замінити наявний",
  "mcp.submit": "Додати",
  "mcp.added": "Додано: {name}",
  "mcp.removeServer": "Прибрати сервер",
  "mcp.removedDetail": "Прибрано: {name}. Гранти знято: {count}. Значення env/headers не відновлюються.",
  "mcp.removeHint": "Значення env і headers зникнуть разом із сервером",
  "mcp.noServers": "Жодного MCP-сервера",
  "mcp.valueHidden": "значення не показується",
  ...
  "mobile2.board.stalled": "немає нових даних · {age}",
  ...
  "mobile2.pipeline.stageTitle": "{role} · {stage}",
  ...
  "mobile2.pipeline.archive": "Архівувати",
  ...
  "mobile2.pipeline.archived": "Заархівовано",
  ...
  "mobile2.board.killedAge": "звʼязок втрачено під час ходу · {age}",
  ...
  "perms.title": "Дозволи",
  "perms.bucket.allow": "Дозволено",
  "perms.bucket.deny": "Заборонено",
  "perms.bucket.ask": "Питати",
  "perms.addTitle": "Додати правило",
  "perms.addBucket": "Куди додати",
  "perms.add": "Додати",
  "perms.remove": "Прибрати {rule}",
  "perms.protected": "захисне",
  "perms.shadowed": "не діє: те саме правило є в заборонах",
  "perms.mode": "Режим за замовчуванням: {mode}",
  "perms.confirmAnyway": "Все одно додати",
  "machines.title": "Машини й запуск",
  "machines.machine": "Машина",
  "machines.project": "Проєкт",
  "machines.engine": "Рушій",
  "machines.model": "Модель",
  "machines.account": "Акаунт",
  "machines.machineDefault": "акаунт машини за замовчуванням",
  "machines.pickMachineFirst": "спершу оберіть машину",
  "machines.noAccounts": "на цій машині профілів немає",
  "machines.fresh": "Оновити код перед стартом (pull / clone)",
  "machines.prompt": "Перший промпт",
  "machines.start": "Запустити",
  "machines.started": "Запущено: {name}",
  "machines.code": "Код: {action}",
  "machines.modeStart": "Нова",
  "machines.modeMove": "Перенести",
  "machines.source": "Зараз працює на",
  "machines.session": "Сесія",
  "machines.noSessions": "там немає піднятих сесій",
  "machines.move": "Перенести сюди",
  "machines.moved": "Перенесено: {name}",
  "composer.moreSendOptions": "Інші способи надсилання",
  "composer.keyboardHint": "Enter — надіслати · Shift+Enter — новий рядок",
  "composer.mentionAgents": "Живі агенти",
  "composer.mentionHint": "Виберіть агента — це згадка для HQ",
  "composer.mentionEmpty": "Живого агента не знайдено. Esc закриває список.",
  "agentAction.replay": "Повторний виклик",
  "agentAction.spawn": "Створити агента: {name}",
  "agentAction.message": "Повідомлення для {name}",
  "agentAction.pending": "Надсилається…",
  "agentAction.queued": "Прийнято до доставки",
  "agentAction.held": "Доставку призупинено",
  "agentAction.delivered": "Доставку підтверджено",
  "agentAction.failed": "Дія не вдалася",
  "agentAction.unknown": "Доставку не підтверджено",
  "agentAction.created": "Розмову створено",
  "agentAction.recorded": "Статус зафіксовано на момент цієї дії.",
  "agentAction.noText": "У цьому записі немає тексту повідомлення.",
  "agentAction.truncated": "Довге повідомлення скорочено в попередньому перегляді транскрипту.",
  "agentAction.technical": "Технічні деталі",
  "agentAction.open": "Відкрити розмову",
  "agentAction.agent": "агента",
  "settings.work": "Робота й історія",
  "settings.access": "Доступ і підключення",
  "settings.behavior": "Поведінка застосунку",
  "roles.refresh": "Оновити",
  "roles.retry": "Спробувати ще раз",
  "roles.sourceConsole": "Ролі з пульта · {count} · прочитано {at}",
  "roles.sourceFallback": "Вбудовані ролі · {count} · дані пульта недоступні",
  "roles.stale": "Не вдалося оновити — показано дані, прочитані {at}.",
  "roles.unreachable": "Каталог ролей не читається.",
  "roles.degradedMissing": "Пульт fleetctl не встановлений на цій машині.",
  "roles.degradedUnavailable": "Пульт не відповів: {detail}",
  "roles.degradedEmpty": "Пульт не повернув жодної ролі.",
  "roles.degradedOverrides": "Файл перекриттів не читається: {detail}",
  "roles.readOnly": "Пульт недоступний — тут лише читання.",
  "roles.own": "Власна роль — насіння немає, повертати нема до чого.",
  "roles.launchable": "Доступна для нового запуску.",
  "roles.blockedBadge": "не запуститься",
  "roles.blocked": "Не можна запустити: {reason}",
  "roles.noDelegation": "Не створює субагентів: дошка не має політики делегування для цієї ролі. Запуск працює, дочірні агенти — ні.",
  "roles.unsupportedConsumers": "Конвеєри й запуск через MCP цю роль не приймають — ці входи приймають лише вбудовані вісім. Відмова буде до запуску, не після.",
  "roles.runtimeConsoleOnly": "Рушій, модель і effort змінюються тільки в пульті; тут редагується промпт.",
  "roles.nextRunOnly": "Діє для наступних запусків — уже живі агенти не переналаштовуються.",
  "roles.savedUnconfirmed": "Зміни записано, актуальну версію не підтверджено: {detail}",
  "roles.title": "Ролі",
  "roles.edited": "змінено",
  "roles.reset": "Повернути початковий",
  "roles.save": "Зберегти",
  "roles.chars": "{count} символів",
  "roles.updatedAt": "змінено {at}",
  "roles.promptAria": "Промпт ролі {role}",
  "firms.title": "Фірми",
  "firms.unreachable": "Конфіг-консоль не відповідає.",
  "firms.unreachableHint": "Фірми й проєкти читаються тільки з неї.",
  "firms.none": "Жодної фірми ще не створено.",
  "firms.newFirm": "Нова фірма",
  "firms.newProject": "Новий проєкт",
  "firms.addProject": "+ Проєкт",
  "firms.editFirm": "Редагувати фірму",
  "firms.projectCount": { one: "{count} проєкт", few: "{count} проєкти", many: "{count} проєктів", other: "{count} проєктів" },
  "firms.sectionProjects": "Проєкти",
  "firms.sectionPeople": "Люди",
  "firms.sectionInherited": "Діє на всі проєкти",
  "firms.rowMcp": "MCP",
  "firms.rowSkills": "Навички",
  "firms.rowSecrets": "Секрети",
  "firms.rowRules": "Правила",
  "firms.sourceOwn": "Власні проєкту",
  "firms.sourceFirm": "Від фірми {firm}",
  "firms.subfolder": "підпапка",
  "firms.noDetail": "Деталі не читаються.",
  "firms.nothingApplies": "Нічого не діє на цьому рівні.",
  "firms.create": "Створити",
  "firms.save": "Зберегти",
  "firms.cancel": "Скасувати",
  "firms.edit": "Редагувати",
  "firms.fieldId": "slug фірми",
  "firms.fieldProjectId": "slug проєкту",
  "firms.fieldName": "Назва",
  "firms.fieldPeople": "Люди, через кому",
  "firms.fieldPath": "Шлях на диску",
  "firms.fieldParent": "Усередині проєкту",
  "firms.noParent": "Окремий проєкт",
  "secrets.aliveOf": "{alive} з {total} живих",
  "secrets.dead": { one: "{count} мертвий", few: "{count} мертві", many: "{count} мертвих", other: "{count} мертвих" },
  "secrets.unchecked": { one: "{count} не перевірений", few: "{count} не перевірені", many: "{count} не перевірених", other: "{count} не перевірених" },
  "secrets.checkedAt": "остання перевірка {at}",
  "secrets.sectionKeys": "Ключі",
  "secrets.sectionAccounts": "Акаунти",
  "secrets.sectionClis": "Входи CLI",
  "secrets.filterAria": "Фільтр за станом",
  "secrets.filterAll": "Усі",
  "secrets.filterDead": "Мертві",
  "secrets.filterUnchecked": "Не перевірені",
  "secrets.stateAlive": "живий",
  "secrets.stateDead": "мертвий",
  "secrets.stateUnchecked": "не перевірено",
  "secrets.groupToggle": "{provider}, розгорнути",
  "secrets.sharedWith": "поділено: {list}",
  "secrets.shareGlobal": "Видати всім проєктам",
  "secrets.unshareGlobal": "Забрати в усіх проєктів",
  "secrets.shareTarget": "Кому: firm:<id> або project:<id>",
  "secrets.share": "Видати",
  "secrets.unshare": "забрати",
  "secrets.limit": "ліміт {value}",
  "secrets.cliSignedIn": "увійдено",
  "secrets.cliSignedOut": "не увійдено",
  "secrets.emptyMissing": "Інвентар ще не зібрано.",
  "secrets.emptyMissingHint": "Файл інвентарю не знайдено — його збирає окремий агент.",
  "secrets.emptyUnreadable": "Не вдалося прочитати інвентар.",
  "secrets.emptyUnreadableHint": "Файл є, але його вміст не розбирається.",
  "secrets.emptyNone": "В інвентарі немає жодного ключа.",
  "secrets.emptyDeadNone": "Мертвих ключів немає.",
  "secrets.emptyUncheckedNone": "Неперевірених ключів немає.",
  "secrets.add": "+ Секрет",
  "secrets.addTitle": "Новий секрет",
  "secrets.id": "Ідентифікатор",
  "secrets.label": "Назва",
  "secrets.provider": "Провайдер",
  "secrets.purpose": "Нащо цей ключ",
  "secrets.envName": "Змінна середовища",
  "secrets.value": "Значення",
  "secrets.valueHint": "Зберігається у файлі з правами 600, назад не показується",
  "secrets.scope": "Область",
  "secrets.scopeNone": "поки нікому",
  ...
  "hq.identity.avatar": "Аватар",
  "hq.identity.change": "Змінити",
  "hq.identity.remove": "Прибрати",
  "hq.identity.saved": "Збережено",
  ...
  "desktop.launchTitle": "Запустити сесію",
  "desktop.sectionSessions": "Сесії",
  "desktop.move": "перенести",
  "desktop.noAgents": "У проєкті ще немає сесій.",
  "desktop.sectionArchive": "Архів проєкту",
  "desktop.sectionCode": "Код на машинах",
  "desktop.codeMissing": "теки немає",
  "desktop.codeDirty": "незакомічені зміни",
  "desktop.sectionSkills": "Скіли",
  "desktop.sectionMcp": "MCP",
  "desktop.sectionSecrets": "Секрети",
  "desktop.fromFirm": "від фірми",
  "desktop.fromProject": "від проєкту",
  "desktop.own": "власний",
  "desktop.revoke": "зняти",
  "desktop.addGrant": "+ видати",
  "desktop.tellHq": "Сказати HQ",
  "desktop.tellHqLine": "Відкриваю проєкт {firm} → {project} ({path})",
  "desktop.tellHqSent": "HQ отримав.",
  "desktop.tellHqNoSeat": "HQ не запущений.",
  "desktop.detailFailed": "Проєкт не читається: {reason}",
  "archive.title": "Архів сесій",
  "archive.unavailable": "Архів ще не підключено.",
