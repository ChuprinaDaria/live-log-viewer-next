...
export const uk: Record<keyof typeof en, Message> = {
  ...
  "roles.stale": "Каталог не вдалося оновити. Показані ролі можуть бути застарілими.",
  "roles.readOnly": "Ця роль тут лише для читання. Додаткові ролі пульта ще не підтримуються редактором і запуском ролей дошки.",
  ...
  "roles.sourceConsole": "Каталог із пульта. Тут можна редагувати лише ролі, які підтримує ця дошка.",
  "roles.sourceFallback": "Пульт fleetctl недоступний — показані вбудовані ролі, редагувати тут не можна.",
