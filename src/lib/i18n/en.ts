...
export const en = {
  ...
  "roles.stale": "The catalog could not be refreshed. The displayed roles may be outdated.",
  "roles.readOnly": "This role is read-only here. Console-only roles are not yet supported by the board’s role editor and launcher.",
  ...
  "roles.sourceConsole": "Roles are read from the console. Only roles supported by this board can be edited here.",
  "roles.sourceFallback": "The fleetctl console is unavailable — these are the built-in roles and cannot be edited here.",
