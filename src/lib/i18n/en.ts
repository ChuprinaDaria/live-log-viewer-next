...
export const en = {
  ...
  "accounts.removeConfirm": "Remove this account? Its past conversations stay readable.",
  ...
  "draft.handoffLabel": "continues: {title}",
  "draft.newConvo": "new conversation",
  "draft.advanced": "Settings",
  "draft.advancedAria": "Agent launch settings",
  "draft.summaryModelDefault": "default",
  "draft.summaryEffortDefault": "default",
  "draft.hintNewShort": "Write the first prompt — the agent starts working here.",
  "draft.hintRelayShort": "The agent reads the conversation and continues from there.",
  "draft.summaryConversation": "conversation",
  "draft.clearDirAria": "No directory — just a conversation",
  "draft.noDirHint": "No directory: the agent works in the home directory, this is just a conversation.",
  ...
  /* Connecting a second Telegram account by phone number: a QR code shown on
     the same phone has nothing to scan it with. */
  "telegram.addAccount": "+ Telegram account",
  "telegram.slug": "Identifier",
  "telegram.phone": "Phone number",
  "telegram.sendCode": "Send code",
  "telegram.code": "Code from Telegram",
  "telegram.codeInvalid": "Code did not match",
  "telegram.floodWait": "Telegram asks to wait {seconds} s",
  "telegram.connected": "Connected: {who}",
  "telegram.byPhone": "by phone",
  "telegram.accounts": "Accounts",
  "telegram.vaultMissing": "Vault did not record the session: {reason}",
  "telegram.err.phone_invalid": "Telegram does not accept that number.",
  "telegram.err.code_invalid": "The code did not match.",
  "telegram.err.flood_wait": "Telegram asks you to wait before trying again.",
  ...
  "mobile2.tabs.aria": "App sections",
  "mobile2.tabs.chat": "Chat",
  "mobile2.tabs.sessions": "Sessions",
  "mobile2.tabs.secrets": "Secrets",
  "mobile2.tabs.mcp": "MCP",
  "mobile2.tabs.settings": "Settings",
  "mobile2.settings.title": "Settings",
  "mobile2.soon.chat": "Group chat with the orchestrator and agents is not built yet.",
  "mcp.up": "up",
  "mcp.down": "down",
  "mcp.grantedToNobody": "granted to nobody",
  "mcp.editGrants": "Change who holds {item}",
  "mcp.grantTitle": "Grant {item} to",
  "mcp.grantTarget": "Target",
  "mcp.grantHint": "firm:<id> · project:<id> · agent:<role> · fleet:hq · fleet:worker",
  "mcp.grant": "Grant",
  "mcp.revoke": "Revoke",
  "mcp.add": "+ Server",
  ...
  "mcp.headers": "Headers",
  "mcp.addRow": "+ row",
  "mcp.replace": "Replace existing",
  "mcp.submit": "Add",
  "mcp.added": "Added: {name}",
  "mcp.removeServer": "Remove server",
  "mcp.removedDetail": "Removed: {name}. Grants revoked: {count}. Env/header values cannot be restored.",
  "mcp.removeHint": "Env and header values go with the server",
  "mcp.noServers": "No MCP servers yet",
  "mcp.valueHidden": "value is not shown",
  ...
  "mobile2.pipeline.archive": "Archive",
  ...
  "mobile2.pipeline.archived": "Archived",
  ...
  "perms.bucket.allow": "Allowed",
  "perms.bucket.deny": "Denied",
  "perms.bucket.ask": "Ask",
  "perms.addTitle": "Add a rule",
  "perms.addBucket": "Where to add it",
  "perms.add": "Add",
  "perms.remove": "Remove {rule}",
  "perms.protected": "protective",
  "perms.shadowed": "inert: the same rule is denied",
  "perms.mode": "Default mode: {mode}",
  "perms.confirmAnyway": "Add it anyway",
  "machines.title": "Machines and launch",
  "machines.machine": "Machine",
  "machines.project": "Project",
  "machines.engine": "Engine",
  "machines.model": "Model",
  "machines.account": "Account",
  "machines.machineDefault": "the machine\u2019s default account",
  "machines.pickMachineFirst": "pick a machine first",
  "machines.noAccounts": "no profiles enrolled on this machine",
  "machines.fresh": "Refresh code before start (pull / clone)",
  "machines.prompt": "First prompt",
  "machines.start": "Start",
  "machines.started": "Started: {name}",
  "machines.code": "Code: {action}",
  "machines.modeStart": "Start new",
  "machines.modeMove": "Move existing",
  "machines.source": "Now running on",
  "machines.session": "Session",
  "machines.noSessions": "no sessions running there",
  "machines.move": "Move here",
  "machines.moved": "Moved: {name}",
  "composer.moreSendOptions": "More send options",
  "composer.keyboardHint": "Enter to send · Shift+Enter for a new line",
  "composer.mentionAgents": "Live agents",
  "composer.mentionHint": "Choose an agent · this adds a reference for HQ",
  "composer.mentionEmpty": "No live agent matches. Esc closes the list.",
  "agentAction.replay": "Replay",
  "agentAction.spawn": "Create agent: {name}",
  "agentAction.message": "Message to {name}",
  "agentAction.pending": "Sending…",
  "agentAction.queued": "Accepted for delivery",
  "agentAction.held": "Delivery on hold",
  "agentAction.delivered": "Delivery confirmed",
  "agentAction.failed": "Action failed",
  "agentAction.unknown": "Delivery not confirmed",
  "agentAction.created": "Conversation created",
  "agentAction.recorded": "Status recorded at the time of this action.",
  "agentAction.noText": "No message text in this record.",
  "agentAction.truncated": "This long message is shortened in the transcript preview.",
  "agentAction.technical": "Technical details",
  "agentAction.open": "Open conversation",
  "agentAction.agent": "agent",
  "settings.work": "Work and history",
  "settings.access": "Access and connections",
  "settings.behavior": "App preferences",
  "roles.refresh": "Refresh",
  "roles.retry": "Try again",
  "roles.sourceConsole": "Console roles · {count} · read {at}",
  "roles.sourceFallback": "Built-in roles · {count} · console data unavailable",
  "roles.stale": "Could not refresh — showing what was read {at}.",
  "roles.unreachable": "The role catalog cannot be read.",
  "roles.degradedMissing": "The fleetctl console is not installed on this machine.",
  "roles.degradedUnavailable": "The console did not answer: {detail}",
  "roles.degradedEmpty": "The console returned no roles at all.",
  "roles.degradedOverrides": "The overrides file cannot be read: {detail}",
  "roles.readOnly": "The console is unavailable — read-only here.",
  "roles.own": "Your own role — it has no seed, so there is nothing to restore.",
  ...
  "roles.savedUnconfirmed": "The change was written; the current version is not confirmed: {detail}",
  "roles.title": "Roles",
  "roles.edited": "edited",
  "roles.reset": "Restore original",
  "roles.save": "Save",
  "roles.chars": "{count} characters",
  "roles.updatedAt": "edited {at}",
  "roles.promptAria": "Prompt of the {role} role",
  "firms.title": "Firms",
  "firms.unreachable": "The config console is not answering.",
  "firms.unreachableHint": "Firms and projects are read only from it.",
  "firms.none": "No firm has been created yet.",
  "firms.newFirm": "New firm",
  "firms.newProject": "New project",
  "firms.addProject": "+ Project",
  "firms.editFirm": "Edit the firm",
  "firms.projectCount": { one: "{count} project", other: "{count} projects" },
  "firms.sectionProjects": "Projects",
  "firms.sectionPeople": "People",
  "firms.sectionInherited": "Applies to every project",
  "firms.rowMcp": "MCP",
  "firms.rowSkills": "Skills",
  "firms.rowSecrets": "Secrets",
  "firms.rowRules": "Rules",
  "firms.sourceOwn": "The project's own",
  "firms.sourceFirm": "From the firm {firm}",
  "firms.subfolder": "subfolder",
  "firms.noDetail": "The detail cannot be read.",
  "firms.nothingApplies": "Nothing applies at this level.",
  "firms.create": "Create",
  "firms.save": "Save",
  "firms.cancel": "Cancel",
  "firms.edit": "Edit",
  "firms.fieldId": "firm slug",
  "firms.fieldProjectId": "project slug",
  "firms.fieldName": "Name",
  "firms.fieldPeople": "People, comma separated",
  "firms.fieldPath": "Path on disk",
  "firms.fieldParent": "Inside the project",
  "firms.noParent": "A project of its own",
  "secrets.aliveOf": "{alive} of {total} alive",
  "secrets.dead": { one: "{count} dead", other: "{count} dead" },
  "secrets.unchecked": { one: "{count} unchecked", other: "{count} unchecked" },
  "secrets.checkedAt": "last checked {at}",
  "secrets.sectionKeys": "Keys",
  "secrets.sectionAccounts": "Accounts",
  "secrets.sectionClis": "CLI logins",
  "secrets.filterAria": "Filter by state",
  "secrets.filterAll": "All",
  "secrets.filterDead": "Dead",
  "secrets.filterUnchecked": "Unchecked",
  "secrets.stateAlive": "alive",
  "secrets.stateDead": "dead",
  "secrets.stateUnchecked": "unchecked",
  "secrets.groupToggle": "{provider}, expand",
  "secrets.sharedWith": "shared with: {list}",
  "secrets.shareGlobal": "Share with every project",
  "secrets.unshareGlobal": "Stop sharing with every project",
  "secrets.shareTarget": "To: firm:<id> or project:<id>",
  "secrets.share": "Share",
  "secrets.unshare": "stop",
  "secrets.limit": "limit {value}",
  "secrets.cliSignedIn": "signed in",
  "secrets.cliSignedOut": "not signed in",
  "secrets.emptyMissing": "The inventory has not been collected yet.",
  "secrets.emptyMissingHint": "No inventory file — a separate agent writes it.",
  "secrets.emptyUnreadable": "The inventory could not be read.",
  "secrets.emptyUnreadableHint": "The file is there, but its contents do not parse.",
  "secrets.emptyNone": "The inventory holds no keys.",
  "secrets.emptyDeadNone": "No dead keys.",
  "secrets.emptyUncheckedNone": "No unchecked keys.",
  "secrets.add": "+ Secret",
  "secrets.addTitle": "New secret",
  "secrets.id": "Identifier",
  "secrets.label": "Label",
  "secrets.provider": "Provider",
  "secrets.purpose": "What this key is for",
  "secrets.envName": "Environment variable",
  "secrets.value": "Value",
  "secrets.valueHint": "Stored in a 0600 file, never shown again",
  "secrets.scope": "Scope",
  "secrets.scopeNone": "nobody yet",
  ...
  "hq.identity.avatar": "Avatar",
  "hq.identity.change": "Change",
  "hq.identity.remove": "Remove",
  "hq.identity.saved": "Saved",
  ...
  "desktop.launchTitle": "Start a session",
  "desktop.sectionSessions": "Sessions",
  "desktop.move": "move",
  "desktop.noAgents": "No sessions in this project yet.",
  "desktop.sectionArchive": "Project archive",
  "desktop.sectionCode": "Code on machines",
  "desktop.codeMissing": "no directory",
  "desktop.codeDirty": "uncommitted changes",
  "desktop.sectionSkills": "Skills",
  "desktop.sectionMcp": "MCP",
  "desktop.sectionSecrets": "Secrets",
  "desktop.fromFirm": "from firm",
  "desktop.fromProject": "from project",
  "desktop.own": "own",
  "desktop.revoke": "revoke",
  "desktop.addGrant": "+ grant",
  "desktop.tellHq": "Tell HQ",
  "desktop.tellHqLine": "Opening project {firm} → {project} ({path})",
  "desktop.tellHqSent": "HQ has it.",
  "desktop.tellHqNoSeat": "HQ is not running.",
  "desktop.detailFailed": "Project could not be read: {reason}",
  "archive.title": "Session archive",
  "archive.unavailable": "Archive not wired yet.",
